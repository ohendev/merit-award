...
laurent = User.create(username: "Laurent", email: "laurent@gmail.com", password: "123456")
...
Review.create(topic: "Congés Paternité", comment: "Ils m'ont été refusés", stars: 1, company: bp, user: laurent)
...
Review.create(topic: "Progression", comment: "Les opportunités d'avancement sont possible", stars: 3, company: lock, user: laurent)
...
Review.create(topic: "Progression", comment: "Les opportunités de carrière sont bonnes", stars: 4, company: ama, user: laurent)
